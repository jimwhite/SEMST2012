...
./convert_conll_to_mallet.groovy data/sys0.train.conll.txt false
...
./convert_conll_to_mallet.groovy data/sys1.train.conll.txt false
...
./convert_event_to_conll.groovy data/sys1.train.conll.txt data/sys2.train.event.txt data/sys.train.conll.txt false
./convert_event_to_conll.groovy data/sys1.dev.conll.txt data/sys2.dev.event.txt data/sys.dev.conll.txt false
